    ...
    <div v-if="show" class="export-modal-overlay" @click.self="handleClose">
      ...
      >
            ...
            <CustomScrollbar class="export-item-items-scroll">
              ...
              >
                ...
                <div class="export-item-info">
                  ...
                  <div class="export-item-desc" :title="it.desc">
                    {{ it.desc || t('common.noDescription') }}
                  </div>
                </div>
              </div>
            </CustomScrollbar>
          ...
          <div class="export-settings">
            ...
            <div class="export-format-cards">
              ...
              >
                ...
                <div class="export-format-card-text">
                  <div class="export-format-card-title">
                    {{ t('exportModal.format.json.title') }}
                  </div>
              ...
              >
                ...
                <div class="export-format-card-text">
                  <div class="export-format-card-title">
                    {{ t('exportModal.format.png.title') }}
                  </div>
            ...
            <div v-if="exportFormat === 'png'" class="export-image-upload">
              ...
              >
                ...
                <template v-else>
                  ...
                  <span class="export-image-main-text">{{
                    t('exportModal.embedImage.dropzone')
                  }}</span>
                  <span class="export-image-note">{{
                    t('exportModal.embedImage.note', { type: dataTypeName })
                  }}</span>
                </template>
              </div>
            </div>
        ...
        <footer class="export-modal-footer">
          ...
          <button class="export-btn-cancel" @click="handleClose">
