...
<template>
  <section data-scope="load-game-view" class="lgv">
    ...
    <transition-group v-else name="lgv" tag="div" class="lgv-list">
      <div v-for="it in items" :key="it.file" class="lgv-card lgv-item">
        <div class="lgv-row">
          <div class="lgv-main">
            <div class="lgv-card-title">
              <div class="lgv-title-row">
                <div class="lgv-title-left">
                  ...
                  <span v-if="it.type" class="lgv-type-badge" :class="'type-' + it.type">
                    {{
                      it.type === 'sandbox'
                        ? t('home.newChat.typeSandbox')
                        : t('home.newChat.typeThreaded')
                    }}
                  </span>
                </div>
              ...
              <div class="lgv-participants">
                <div class="lgv-actor">
                  <div
                    class="lgv-actor-avatar"
                    :class="{ 'role-assistant': !it.characterAvatarUrl }"
                  >
                    <img
                    ...
                    <span v-else class="lgv-actor-initial">
                      {{
                        (it.characterName || characterName(it.character) || it.name || '?').slice(
                          0,
                          1,
                        )
                      }}
          ...
          <div class="lgv-card-actions">
            ...
            <button class="btn secondary" :title="t('home.loadGame.delete')" @click="onDelete(it)">
      ...
      <div v-if="items.length === 0" key="empty" class="lgv-card lgv-item lgv-empty-card">
        <div class="lgv-row">
          <div class="lgv-main">
            ...
            <div class="lgv-latest muted lgv-empty-latest">
              {{ t('home.loadGame.noLatestMessage') }}
            </div>
          </div>
...
.lgv-item.lgv-enter-active:nth-last-child(1) {
  transition-delay: 24ms;
}
.lgv-item.lgv-enter-active:nth-last-child(2) {
  transition-delay: 48ms;
}
.lgv-item.lgv-enter-active:nth-last-child(3) {
...
.lgv-skel .sk-row.w-16 {
  width: 64px;
}
.lgv-skel .sk-row.w-24 {
  width: 96px;
}
.lgv-skel .sk-row.w-44 {
  width: 176px;
}
.lgv-skel .sk-row.w-56 {
  width: 224px;
}
.lgv-skel .sk-row.w-72 {
  width: 288px;
}
.lgv-skel .sk-row-sm.w-16 {
  width: 64px;
}
.lgv-skel .sk-row-sm.w-24 {
  width: 96px;
}
